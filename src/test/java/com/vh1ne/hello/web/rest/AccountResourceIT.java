package com.vh1ne.hello.web.rest;

import static com.vh1ne.hello.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.vh1ne.hello.IntegrationTest;
import com.vh1ne.hello.config.Constants;
import com.vh1ne.hello.domain.User;
import com.vh1ne.hello.repository.AuthorityRepository;
import com.vh1ne.hello.repository.UserRepository;
import com.vh1ne.hello.security.AuthoritiesConstants;
import com.vh1ne.hello.service.UserService;
import com.vh1ne.hello.service.dto.AdminUserDTO;
import com.vh1ne.hello.service.dto.PasswordChangeDTO;
import com.vh1ne.hello.service.dto.UserDTO;
import com.vh1ne.hello.web.rest.vm.KeyAndPasswordVM;
import com.vh1ne.hello.web.rest.vm.ManagedUserVM;
